...
export const FAL_IMAGE_MODELS: AIModel[] = [
  {
    ...
    description: "Google Gemini 2.5 Flash — ultra-fast text-to-image generation",
    params: [
      { key: "prompt", label: "Prompt", type: "textarea", required: true, bindable: true },
  ...
  },
  {
    ...
    description: "Google Gemini 3 Pro — higher quality with resolution and web search support",
    params: [
      { key: "prompt", label: "Prompt", type: "textarea", required: true, bindable: true },
      { key: "num_images", label: "Number of Images", type: "number", default: 1, min: 1, max: 4 },
      { key: "aspect_ratio", label: "Aspect Ratio", type: "select", default: "1:1", options: [
  ...
  },
  {
    ...
    description: "Professional-grade text-to-image by Black Forest Labs",
    params: [
      { key: "prompt", label: "Prompt", type: "textarea", required: true, bindable: true },
  ...
  },
  {
    ...
    description: "Fast open-source SDXL image generation with LoRA support",
    params: [
      { key: "prompt", label: "Prompt", type: "textarea", required: true, bindable: true },
...
export const FAL_IMAGE_TO_IMAGE_MODELS: AIModel[] = [
  {
    ...
    description: "Edit or remix images with Gemini 2.5 Flash — supports multiple reference images",
    params: [
      { key: "prompt", label: "Edit Prompt", type: "textarea", required: true, bindable: true },
      { key: "image_urls", label: "Reference Image URLs", type: "text", required: true, bindable: true, description: "One or more image URLs (auto-filled from connected nodes)" },
      { key: "num_images", label: "Number of Images", type: "number", default: 1, min: 1, max: 4 },
  ...
  },
  {
    ...
    description: "Edit or remix images with Gemini 3 Pro — supports multiple reference images",
    params: [
      { key: "prompt", label: "Edit Prompt", type: "textarea", required: true, bindable: true },
      { key: "image_urls", label: "Reference Image URLs", type: "text", required: true, bindable: true, description: "One or more image URLs (auto-filled from connected nodes)" },
      { key: "num_images", label: "Number of Images", type: "number", default: 1, min: 1, max: 4 },
  ...
  {
    id: "fal-flux-pro-redux",
    name: "FLUX.1 Pro Redux — Image to Image",
    provider: "fal",
    category: "image",
    costPerUse: 5,
    isFal: true,
    falEndpoint: "fal-ai/flux-pro/v1.1/redux",
    description: "Transform images with FLUX Pro — style transfer and image modifications",
    params: [
      { key: "prompt", label: "Prompt", type: "textarea", bindable: true, description: "Optional text prompt to guide the transformation" },
      { key: "image_url", label: "Reference Image URL", type: "text", required: true, bindable: true, description: "Source image to transform (auto-filled from connected nodes)" },
      { key: "image_size", label: "Image Size", type: "select", default: "landscape_4_3", options: [
        { label: "Square HD", value: "square_hd" },
        { label: "Square", value: "square" },
        { label: "Landscape 4:3", value: "landscape_4_3" },
  ...
  {
    id: "fal-sdxl-image-to-image",
    name: "SDXL — Image to Image",
    provider: "fal",
    category: "image",
    costPerUse: 3,
    isFal: true,
    falEndpoint: "fal-ai/fast-sdxl/image-to-image",
    description: "Transform images with Stable Diffusion XL — style and content modifications",
    params: [
      { key: "prompt", label: "Prompt", type: "textarea", required: true, bindable: true },
      { key: "image_url", label: "Reference Image URL", type: "text", required: true, bindable: true, description: "Source image to transform (auto-filled from connected nodes)" },
      { key: "strength", label: "Strength", type: "number", default: 0.95, min: 0.05, max: 1, description: "How much the output differs from the input (0.05 = subtle, 1.0 = complete)" },
      { key: "negative_prompt", label: "Negative Prompt", type: "textarea", bindable: true, description: "Details to exclude from the image" },
      { key: "image_size", label: "Image Size", type: "select", default: "square_hd", options: [
        { label: "Square HD", value: "square_hd" },
        { label: "Square", value: "square" },
